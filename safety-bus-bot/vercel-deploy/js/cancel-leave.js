...
class CancelLeaveApp {
    ...
    showStudentInfo() {
        ...
        document.getElementById('student-code').textContent = this.studentData.link_code || '-';
    ...
    showConfirmation() {
        ...
        document.getElementById('confirm-student-code').textContent = this.studentData.link_code || '-';
